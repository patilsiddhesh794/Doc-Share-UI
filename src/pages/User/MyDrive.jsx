...
const MyDrive = () => {
    ...
    const getDriveId = async () => {
        try {
            const { status, data } = await axios.get('http://localhost:3000/openmy_drive');
            if (status === 200) {
                setFid(data?.parentId);
            ...
            <Layout>
                <div className="container-fluid row mt-4">
                    <div className="text-center">
                        <form className="d-flex justify-content-center" role="search" onSubmit={handleCreate}>
                    ...
                    <div className="container-fluid row mt-3">
                        <div className="col-md-4">
                            ...
                            {folders.length < 1 && <h3 className='text-center'>No Folders To Display</h3>}
                                {folders.map((f) => (
                        ...
                        <div className="col-md-8">
                            <h1>Files</h1>
                            {files.length < 1 ? <h3 className='mt-5'>No Uploaded Files</h3> : (
